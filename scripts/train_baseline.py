...
import algorithm.ppo2_baseline as network
import torch
import pandas as pd
...
RANDOM_SEED = 42
SUMMARY_DIR = './summary_baseline_0.1'
MODEL_DIR = './models'
TRAIN_TRACES = './train/'
...
def testing(epoch, nn_model, log_file):
    ...
    # run test script
    os.system('python test_baseline.py ' + nn_model)
    ...
    with open(LOG_FILE + '_test.txt', 'w') as test_log_file:
        ...
        for epoch in range(TRAIN_EPOCH):
            ...
            if epoch % MODEL_SAVE_INTERVAL == 0:
                ...
                print("epoch:{}, qoe:{}, buffer:{}, maxbuf:{}, core:{}".format(epoch, avg_reward, avg_buffer, avg_maxbuf, avg_reward - 0.1 * (avg_buffer/10)))
                ...
                summary_reward = {
                    ...
                    'core': [avg_reward - 0.1 * (avg_buffer/10)]
                }
